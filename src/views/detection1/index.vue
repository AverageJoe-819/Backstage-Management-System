<template>
  <div v-loading="listLoading"
    ...
    <div class="filter-container">
      <el-form ref="ruleForm"
        ...
        <el-form-item label-width="0"
                      prop="data"
                      style="margin:0px">
          <el-input v-model="listQuery.data"
    ...
    <el-table :data="list"
      ...
      <el-table-column :label="$t('detection1.ip')"
                       width="120"
                       align="center">
        <template slot-scope="{row}">
          {{ row.ip }}
      ...
      <el-table-column :label="$t('detection1.url')"
                       width="250"
                       align="center">
        <template slot-scope="{row}">
          {{ row.url }}
      ...
      <el-table-column :label="$t('detection1.data')"
                       width="150"
                       align="center">
        <template slot-scope="{row}">
          {{ row.data }}
      ...
      <el-table-column :label="$t('detection1.content')"
                       align="center">
        <template slot-scope="{row}">
          {{ row.content }}
        </template>
